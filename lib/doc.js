...
function videoToDoc(mediaInfo, captions, captionsUrl, courseInfo, coursePageIndex) {
    ...
    return Object.assign({ "@id": youtubeUrl, "@type": [
            "Resource",
            "Video"
        ], name: mediaName, keywords: courseKeywords, learningResourceType: learningResourceType, inLanguage: courseLanguage, dateCreated: courseStartDate, educationalLevel: courseLevel, license: mitLicense, sourceOrganization: [
            "https://ocw.mit.edu"
